...
import com.xiyao.basic.base.BaseController;
import com.xiyao.basic.base.BaseMapper;
import com.xiyao.basic.base.BaseService;
import com.xiyao.basic.base.BaseServiceImpl;
import lombok.Data;
    ...
    public static void generator() {
        FastAutoGenerator.create(URL, USERNAME, PASSWORD)
                ...
                .strategyConfig((scanner, builder) -> builder
                        ...
                        .enableTableFieldAnnotation().versionColumnName("version").logicDeleteColumnName("del_flag").columnNaming(NamingStrategy.underline_to_camel)
                        // 添加父类公共字段 -> 自定义继承的Entity类全称 -> 格式化文件名称
                        // .addSuperEntityColumns("id", "remark", "create_time", "update_time", "delete_time", "del_flag", "version").superClass(BaseEntity.class).formatFileName("%sEntity")
                        // 添加表字段填充
