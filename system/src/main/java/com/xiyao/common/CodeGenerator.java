    ...
    public static void generator() {
        FastAutoGenerator.create(URL, USERNAME, PASSWORD)
                ...
                .strategyConfig((scanner, builder) -> builder
                        ...
                        // .addSuperEntityColumns("id", "remark", "create_time", "update_time", "delete_time", "deleted", "version").superClass(BaseEntity.class).formatFileName("%sEntity")
                        // 添加表字段填充
